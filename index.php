...
<body class="bg-dark text-white">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navMenu">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item"><a class="nav-link" href="#" data-page="timersPage">Timers</a></li>
        ...
        <div class="d-flex gap-2">
          <button id="themeBtn" class="btn btn-outline-light">Light/Dark</button>
  ...
  <div class="container py-4">
    ...
    <!-- TIMERS PAGE -->
    <section id="timersPage" class="page">
      <h2 class="mb-3">Timers</h2>

      <!-- JAM -->
      <div class="card mb-4">
        <div class="card-body text-center">
          <h3>Jam <span id="jamCount" class="badge bg-light text-dark">#0</span></h3>
      ...
      <div class="card mb-4">
        <div class="card-body text-center">
          <h3>Période <span id="periodNumber" class="badge bg-light text-dark">#1</span></h3>
